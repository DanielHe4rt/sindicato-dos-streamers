                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 col-12">
                            ...
                            <small id="emailHelp" class="form-text text-muted">
                                Nós respeitamos a LGPD/GDPR e caso você queira apagar sua conta todos os dados relacionados serão apagados também!
                            </small>
                            ...
                            <form action="{{ route('me-update') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select" id="exampleSelect1" name="role">
                                        ...
                                        <option
                                            value="streamer" {{ Auth::user()->role == 'streamer' ? 'selected' : '' }}>
                                            Streamer
                                        </option>
                                        <option value="viewer" {{ Auth::user()->role == 'viewer' ? 'selected' : '' }}>
                                            Viewer
                                        </option>
                                    </select>
                                </div>
                                <div class="form-group mt-2">
                                    ...
                                    <select class="form-select" id="exampleSelect1" name="terms">
                                        <option value="0" {{ !Auth::user()->terms ? 'selected' : '' }}>Não</option>
                                        <option value="1" {{ Auth::user()->terms ? 'selected' : '' }}>Sim</option>
                                    </select>
                                    <small id="emailHelp" class="form-text text-muted">Você pode desmarcar caso sinta
                                ...
                                @else
                                    <div class="form-group">
                                        <label for="exampleSelect1">Você gostaria de aparecer na pagina inicial?</label>
                                        <select class="form-select" id="exampleSelect1" name="sent_message">
                                            <option value="0" {{ !Auth::user()->sent_message ? 'selected' : '' }}>Não
                                            </option>
                                            <option value="1" {{ Auth::user()->sent_message ? 'selected' : '' }}>Sim
                                            </option>
                                        </select>
                                    </div>
                                    <small id="emailHelp" class="form-text text-muted">Você pode desmarcar caso sinta
